...
if (!array_key_exists('document_root', $PHPTHUMB_CONFIG)) {
...
//$PHPTHUMB_CONFIG['cache_directory'] = dirname(__FILE__).'/../../var/thumb_cache/';                            // set the cache directory relative to the phpThumb() installation
//$PHPTHUMB_CONFIG['cache_directory'] = $PHPTHUMB_CONFIG['document_root'].'/var/phpthumbcache/'; // set the cache directory to an absolute directory for all source images
...
$PHPTHUMB_CONFIG['disable_imagemagick']        = true;
...
if (!array_key_exists('error_message_image_default', $PHPTHUMB_CONFIG)) {
