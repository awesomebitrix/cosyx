...
class phpthumb {
	...
	var $config_disable_imagemagick                   = true;
...
//		}
	...
	function setOutputFormat() {
		...
		if (!$this->config_disable_imagemagick && $this->ImageMagickVersion()) {
...
//echo $maxwidth.'x'.$maxheight.'<hr>';
	...
	function ExtractEXIFgetImageSize() {
		...
		if (!$this->config_disable_imagemagick && $this->config_prefer_imagemagick) {
	...
	function SourceImageToGD() {
		...
		if (!$this->config_disable_imagemagick && $this->ImageMagickThumbnailToGD()) {
